...
│  │     │  **【易错点】** [常见错误+避坑]
│  │     │
│  │     ├─ 密度：必考 200-400行 / ★重点 100-200行 / 了解 30-80行
│  │     └─ 输出 `{课程}/review/section_NN.md`
│  │
│  ├─ [7.4] 章节收尾：考点速记
│  │  │
│  │  │  每章结束生成速记表，方便回顾+默记+快速翻找：
│  │  │
│  │  │  ## 📋 本章考点速记
│  │  │  | # | 考点 | 一句话理解 | 答题要点 |
│  │  │  |---|------|----------|---------|
│  │  │  | 1 | 法律行为的构成要件 | 意思表示+行为能力+内容合法 | ①先判断意思表示 ②查行为能力 ③审查内容合法性 |
│  │  │  | 2 | 意思表示的瑕疵 | 欺诈/胁迫/重大误解/显失公平 → 可撤销 | ①区分可撤销与无效 ②记住除斥期间 ③举证责任分配 |
│  │  │  | ... | ... | ... | ... |
│  │  │
│  │  │  压缩原则：每考点 1 句话关键理解（≤30字）+ 答题要点123（≤50字）
│  │  │
│  ├─ [7.5] 质量检查
│  │  ├─ 每【必考】考点 ≥ 150行 / 【★重点】≥ 80行
│  │  ├─ 全稿 3000-5000 行（60-100 页 A4）
│  │  ├─ 术语首次出现按语言模式标注
│  │  ├─ 案例嵌入对应考点 / 无"不考"冗余 / 表格完整
│  │  └─ 不通过 → 回 [7.3] 修正
│  │
│  └─ [7.6] 合并输出
