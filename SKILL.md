...
│  │  ├─ [7.3a] 准备：为每个章节打包源材料
│  │  │  │
│  │  │  │  在启动 Agent 之前，主 agent 必须完成以下准备工作：
│  │  │  │
│  │  │  │  □ 从英文笔记中**全量**提取该章节对应内容
│  │  │  │  □ 从中文笔记/教材中**全量**提取该章节对应内容
│  │  │  │  □ 每个相关 PPT/PDF 逐页提取文本 → 打包
│  │  │  │  □ 每个相关阅读材料/论文提取摘要+核心段落 → 打包
│  │  │  │  □ 每个相关案例按六段式结构化 → 打包
│  │  │  │  □ topic_map 中该章的考点列表 + 权重 + 源材料映射
│  │  │  │  □ 语言模式偏好（来自 [0.6]）
│  │  │  │  □ 教材/笔记优先级（来自 [0.7]）
│  │  │  │
│  │  │  │  每个章节的源材料打包为一个独立 prompt → 送给对应 Agent。
│  │  │  │
