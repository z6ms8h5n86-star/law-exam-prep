...
你刚上完国际经济学，老师发了课件PPT，同学在群里传了笔记、往年题、一份考纲。
...
| # | 文件名 | 类型 | 大小 | 修改时间 | 操作 |
|---|--------|------|------|---------|------|
| 1 | 国际经济学课件-第1-8章.pptx | .pptx | 8.2MB | 2026-06-28 | ✅ |
| 2 | 国际经济学笔记-完整版.docx | .docx | 1.3MB | 2026-06-29 | ✅ |
| 3 | 课程往年题2019-2025.pdf | .pdf | 2.1MB | 2026-06-25 | ✅ |
| 4 | 2026国际经济学考纲.docx | .docx | 156KB | 2026-06-20 | ✅ |
| 5 | 案例汇编.docx | .docx | 890KB | 2026-06-27 | ✅ |
...
```
[1/5] 国际经济学课件-第1-8章.pptx → 提取文本... ✅ (48 页幻灯片, 约 12,000 字)
[2/5] 国际经济学笔记-完整版.docx → 提取文本... ✅ (约 18,000 字)
[3/5] 课程往年题2019-2025.pdf → 检测：文本PDF → 提取... ✅ (约 25,000 字)
[4/5] 2026国际经济学考纲.docx → 提取文本... ✅ (约 2,000 字)
[5/5] 案例汇编.docx → 提取文本... ✅ (约 15,000 字)
```
...
|---|------|-------|-------|--------|------|------|-----------|---------|--------|
| 1 | 国际经济学课件.pptx | ✗ | ✗ | ✗ | ✗ | ✗ | 教材 | 教材 | 高 |
| 2 | 国际经济学笔记.docx | ✗ | 含"【★重点】"3处 | ✗ | ✗ | ✗ | 笔记+重点 | 笔记(含重点) | 高 |
| 3 | 课程往年题.pdf | ✗ | ✗ | Q&A结构+分值 | ✗ | 含1道案例题 | — | 往年题 | 高 |
| 4 | 国际经济学考纲.docx | 课程目标+学时 | 含考点权重 | ✗ | ✗ | ✗ | — | 考纲 | 高 |
| 5 | 案例.docx | ✗ | ✗ | ✗ | ✗ | 原告/被告/法院认为 | — | 案例材料 | 高 |
```
...
> 💡 看起来这些内容跟 **课程学** 比较相关。这些资料是关于哪个考试/课程的？

你回答：**"国际经济学 期末"**

Claude：好的，全部 5 个文件归入 **"国际经济学"**。确认？[Y/n]
...
国际经济学  × 5 文件
├── 笔记/          ← 国际经济学笔记-完整版.md
├── 重点与考纲/    ← 2026国际经济学考纲.md
├── 试题/          ← 课程往年题2019-2025.md
├── 案例/          ← 案例汇编.md
└── (教材转笔记)   ← 国际经济学课件-第1-8章.md
```
...
国际经济学/
├── 笔记/
│   ├── 国际经济学课件-第1-8章.md     (教材, 48页转换)
│   └── 国际经济学笔记-完整版.md      (笔记, 含【★重点】标记)
├── 重点与考纲/
│   └── 2026国际经济学考纲.md         (考纲, 考点权重)
├── 试题/
│   └── 课程往年题2019-2025.md     (往年题, 6年)
├── 案例/
│   └── 案例汇编.md         (案例, 15则)
├── _原始文件/                      (原始文件保留)
└── 国际经济学概述.md                 (MOC索引)
...
| 课程 | 文件 | 类型分布 |
|------|------|---------|
| 国际经济学 | 5 | 教材×1, 笔记(含重点)×1, 往年题×1, 考纲×1, 案例×1 |

### 下一步建议
🔍 发现考纲1份 + 重点标记3处 + 往年题6年 → 建议立即触发生成复习
📋 回复 "生成复习" 或 /final-review 生成复习 for {课程名}
```

### Step 11: 触发复习生成（可选）

回复 "生成复习" → /final-review 自动以考纲为骨架、以笔记为素材、以往年题为权重，生成逐章复习稿。
...
# Step 5: 格式转换
python tools/format_converter.py -i 国际经济学课件.pptx -m pptx2md -o 课件.md
python tools/format_converter.py -i 国际经济学笔记.docx -m docx2md -o 笔记.md
python tools/format_converter.py -i 课程往年题.pdf -m pdf2md -o 往年题.md
...
# Step 9: 生成输出
python tools/output_writer.py -i ./国际经济学/ -f all -o ./output/
# → 生成 output/国际经济学.md + .html + .pdf + .docx
```
